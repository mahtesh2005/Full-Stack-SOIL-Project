...
// Importing CSS styles specific to Nuts_GrainsItem and a general slider style.
import "../Fruits/FruitItem.css";
import "../SliderOne.css";

// Functional component to display an individual nuts or grains item.
const Nuts_GrainsItem = ({ itemID, item_name, item_price, image, username }) => {
    // Using useContext hook to access cart items and actions from the global store.
    const { cartItems, addToCart, removeFromCart } = useContext(StoreContext);

    // Returning JSX to render the nuts or grains item.
    return (
...
// Exporting the Nuts_GrainsItem component as the default export of this module.
export default Nuts_GrainsItem;
